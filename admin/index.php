...
<div class="content">
  ...
  <div class="row" id="student">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_dept"  class="form-control" id="input1" placeholder="department ex. BBA(CA)" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_batch"  class="form-control" id="input1" placeholder="batch ex.2022" />
          </div>
      </div>
...
<br><br><br>
  <div class="rowtwo" id="teacher">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Department</label>
          <div class="col-sm-7">
            <input type="text" name="tc_dept"  class="form-control" id="input1" placeholder="department ex. BBA(CA)" />
          </div>
      </div>
